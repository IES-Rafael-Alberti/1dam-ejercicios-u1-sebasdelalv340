...
def pedir_numeros(n1, n2):
    if n1 == n2:
        print("Error : Los números no pueden ser iguales.")
   
def obtener_diferencia_entre_numeros(n1, n2):
    if n1 < n2:
        n_numeros = n2 - n1
        return n_numeros
    else:
...
def obtener_numero_menor(n1, n2):
    if n1 < n2:
        return n1
    else:
        return n2
...
def main():
    ...
    pedir_numeros(n1, n2)
    print(f"El número menor es el {obtener_numero_menor(n1, n2)} y entre ellos existen {obtener_diferencia_entre_numeros(n1, n2)} números enteros.")
