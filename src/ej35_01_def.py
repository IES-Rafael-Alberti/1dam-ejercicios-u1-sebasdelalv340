...
def obtenerMultiplicacion(n1, n2):
	return print(f"{n1} x {n2} =", n1 * n2)

def obtenerDivision(n1, n2):
	if n2 == 0:
		return print("La división por cero no es posible.")
	else:
		return print(f"{n1} / {n2} =", n1 / n2)
...
def main():
    ...
    if opcion == 1:
        print(obtenerSuma(n1, n2))
    elif opcion == 2:
        print(obtenerResta(n1, n2))
    elif opcion == 3:
        print(obtenerMultiplicacion(n1, n2))
    elif opcion == 4:
        print(obtenerDivision(n1, n2))
